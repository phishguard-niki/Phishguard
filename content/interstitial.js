...
(() => {
  ...
  const dict = {
    'zh-TW': { title:'請確認：此網站風險極高', btn:'我已了解風險，仍要繼續', note:'資訊僅供提醒，請勿在此頁輸入個資/金流。需要協助可撥打 165 或造訪 165 全民防騙網。', sourceH:'偵測來源：啟發式', sourceL:'偵測來源：黑名單', sourceR:'偵測來源：Google Safe Browsing 即時偵測' },
    'en':    { title:'Please Confirm: High‑Risk Website', btn:'I understand the risk. Continue anyway', note:'This is a warning only. Do not enter personal/payment info. Need help? Call 165 or visit the 165 Anti‑Fraud Network.', sourceH:'Detection: Heuristic', sourceL:'Detection: Blocklist', sourceR:'Detection: Google Safe Browsing (Real-time)' }
  };
  function render({ lang='zh-TW', source='heuristic' }={}){
    ...
    const sourceText = (source==='realtime')? d.sourceR : (source==='list')? d.sourceL : d.sourceH;
